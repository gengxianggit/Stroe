...
var str="<img  src='pic/"+this.path+"'style= 'width='50px' height='80px''/>";
				str+="<input type='hidden' name='img' value='"+this.path+"' data-id=+'"+this.order+"'/>";
				$("#dndArea").append(str);	
...
<!-- 		</div> -->
		<div class=" clearfix cl">
			...
			<div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="id"></div>
            </div>
			<div class="Add_p_s">
            ...
            <div class="Add_p_s">
			 ...
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="price"></div>
			</div>
            <div class="Add_p_s">
             <label class="form-label col-2">数&nbsp;&nbsp;&nbsp;&nbsp;量：</label>	
			 <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder="" id="" name="Inventory"></div>
			</div>
<!--              <div class="Add_p_s"> -->
...
<!-- 			</div> -->
		...
		<div class="clearfix cl">
			...
			<div class="formControls col-10">
				<input type="text" class="input-text" value="" placeholder="" id="" name="intriduceproduction">
			</div>
		</div>
<!-- 		<div class="clearfix cl"> -->
