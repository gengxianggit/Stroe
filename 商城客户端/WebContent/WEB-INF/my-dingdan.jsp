						...
						<c:forEach items="${olist }" var="o">
							<li>
								<div class="member-minute clearfix">
									<span>${o.date }</span>
									<span>订单号：<em>${o.orderName }</em></span>
								...
								<div class="member-circle clearfix">
									<div class="ci1">
									<c:forEach items="${o.odlist }" var="od">
										<div class="ci7 clearfix">
											<span class="gr1"><a href="#"><img src="img/${od.commodity.pictures.get(0).path }" title="" about="" width="60" height="60"></a></span>
											<span class="gr2"><a href="#">/${od.commodity.name}</a></span>
											<span class="gr3">${od.num}</span>
										</div>
											</c:forEach>
										
									</div>
								
									<div class="ci2">${o.ad.name }</div>
									<div class="ci3"><b>${o.orderprice }</b><p>货到付款</p><p class="iphone">手机订单</p></div>
									<div class="ci4"><p>${o.date }</p></div>
									<div class="ci5"><p>等待付款</p> <p><a href="#">物流跟踪</a></p> <p><a href="#">订单详情</a></p></div>
									<div class="ci5 ci8"><p>剩余15时20分</p> <p><a href="#" class="member-touch">立即支付</a> </p> <p><a href="deleteod.do?id=${o.id}" >取消订单</a> </p></div>
								</div>
							</li>
							</c:forEach>
						</ul>
