...
//		thisMb.style.borderColor = '#cd2426';
            ...
            $("#cart").click(function(){
            	var num=$("#num").val();
            	var id=$(".goodId").data("id");
            	location.href="addcart.do?id=${list.get(0).id}&num="+num;
...
<div class="Xcontent">
	<ul class="Xcontent01">
		...
		<div class="Xcontent06"><img src="img/${list.get(0).pictures.get(0).path} " data-id="${list.get(0).id }" class="goodId"></div>
		<ol class="Xcontent08">
		
		<c:forEach items="${list.get(0).pictures }" var="img">
		  <div class="Xcontent07"><img src="img/${img.path }"></div>
			</c:forEach>
		</ol>
		<ol class="Xcontent13 clearfix">
			<div class="Xcontent14 clearfix"><a href="#"><p>${list.get(0).name } </p></a></div>
			<div class="Xcontent15 clearfix red fl" style="margin-top:2px">新品上架</div>
			<div class="Xcontent16 clearfix"><p style="margin:0">新上市手机放肆购，你值得拥有！更多惊喜</p></div>
			<div class="Xcontent17">
				<p class="Xcontent18">售价</p>
				<p class="Xcontent19">￥<span>${list.get(0).price }</span></p>
				<div class="Xcontent20">
					<p class="Xcontent21">促销</p>
					<span  class="Xcontent22" id="youhui">优惠券</span>
			...
			<div class="Xcontent26">
				...
				<c:forEach items="${list.get(0).pictures }" var="img">
				<div class="Xcontent28"><img  src="img/${img.path }"></div>
				</c:forEach>
		...
		<div class="pc-overall">
			...
			<div class="pc-term clearfix">
				<div class="H-over1 pc-text-word clearfix">
					...
					<div>
					<c:forEach items="${list.get(0).pictures }" var="img">	<div style="text-align:center">
		  <img src="img/${img.path } " width="50%">
			</div></c:forEach>
